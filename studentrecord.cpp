...
cout<<"1.Insert and overwrite"<<endl;
cout<<"2.show"<<endl;
cout<<"3.search and edit number"<<endl;
cout<<"4.search and edit name"<<endl;
cout<<"5.search and edit(only number)"<<endl;
cout<<"6.search and edit (only name)"<<endl;
cout<<"7.Delet a student record"<<endl;
